defmodule BoardWeb.Router do
  ...
  scope "/", BoardWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{BoardWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", BoardWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{BoardWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", BoardWeb do
    ...
    live_session :current_user,
      on_mount: [{BoardWeb.UserAuth, :mount_current_user}] do
